...
class Organization(models.Model):
    ...
    def get_savings_config(self) -> dict:
        ...
        base_config.update(
            {k: v for k, v in config.items() if k != "benchmark_profile"}
        )
    ...
    def save(self, *args, **kwargs):
        ...
        if self.is_primary:
            ...
            with transaction.atomic():
                ...
                existing_primaries = (
                    UserOrganizationMembership.objects.select_for_update()
...
class AuditLog(models.Model):
    ...
    ALLOWED_DETAIL_KEYS = {
        ...
        "invoices_deleted",
        "purchase_orders_deleted",
        "goods_receipts_deleted",
        "purchase_requisitions_deleted",
        # Reports module keys
        "report_type",
        "report_id",
        "schedule_id",
        ...
        "is_public",
        "shared_count",
        "frequency",  # Report sharing and scheduling
        # P2P Analytics keys
        "weeks",
        "stage",
        "invoice_id",
