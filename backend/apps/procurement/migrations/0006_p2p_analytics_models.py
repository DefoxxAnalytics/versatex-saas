...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="procurement_organiz_6af0c7_idx",
                    ),
                    models.Index(
                        fields=["organization", "match_status"],
                        name="procurement_organiz_c2e775_idx",
                    ),
                    models.Index(
                        fields=["organization", "due_date"],
                        name="procurement_organiz_9d12c3_idx",
                    ),
                    models.Index(
                        fields=["organization", "supplier"],
                        name="procurement_organiz_e37e7f_idx",
                    ),
                    models.Index(
                        fields=["organization", "has_exception"],
                        name="procurement_organiz_d9b787_idx",
                    ),
                    models.Index(
                        fields=["organization", "invoice_date"],
                        name="procurement_organiz_587d53_idx",
                    ),
                    models.Index(fields=["uuid"], name="procurement_uuid_8649b1_idx"),
                    models.Index(
                        fields=["upload_batch"], name="procurement_upload__5bf7f5_idx"
                    ),
                ],
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["organization", "status"], name="procurement_organiz_361ce5_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="goodsreceipt",
            index=models.Index(
                fields=["organization", "received_date"],
                name="procurement_organiz_d0a000_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="goodsreceipt",
            index=models.Index(
                fields=["organization", "purchase_order"],
                name="procurement_organiz_0c4b02_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="goodsreceipt",
        ...
        migrations.AddIndex(
            model_name="goodsreceipt",
            index=models.Index(
                fields=["upload_batch"], name="procurement_upload__797cb4_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["organization", "status"], name="procurement_organiz_cfbcf3_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="purchaserequisition",
            index=models.Index(
                ...
                name="procurement_organiz_3cf3d4_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="purchaserequisition",
            index=models.Index(
                ...
                name="procurement_organiz_7aefc4_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="purchaserequisition",
            index=models.Index(
                ...
                name="procurement_organiz_225cf9_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="purchaserequisition",
        ...
        migrations.AddIndex(
            model_name="purchaserequisition",
            index=models.Index(
                fields=["upload_batch"], name="procurement_upload__13bb72_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="purchaserequisition",
        ...
        migrations.AddIndex(
            model_name="purchaseorder",
            index=models.Index(
                fields=["organization", "status"], name="procurement_organiz_67bb1c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="purchaseorder",
            index=models.Index(
                fields=["organization", "supplier"],
                name="procurement_organiz_de1d7c_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="purchaseorder",
            index=models.Index(
                fields=["organization", "created_date"],
                name="procurement_organiz_914a3e_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="purchaseorder",
            index=models.Index(
                fields=["organization", "is_contract_backed"],
                name="procurement_organiz_29acc8_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="purchaseorder",
        ...
        migrations.AddIndex(
            model_name="purchaseorder",
            index=models.Index(
                fields=["upload_batch"], name="procurement_upload__fb7a8f_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="purchaseorder",
