...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="category",
            index=models.Index(
                fields=["organization", "name"], name="procurement_organiz_05eb76_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="procurement_organiz_425736_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="dataupload",
            index=models.Index(
                fields=["batch_id"], name="procurement_batch_i_f26efc_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="supplier",
            index=models.Index(
                fields=["organization", "name"], name="procurement_organiz_a3bcf3_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="supplier",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["organization", "-date"], name="procurement_organiz_ba69c9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="transaction",
            index=models.Index(
                ...
                name="procurement_organiz_c15d59_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="transaction",
            index=models.Index(
                ...
                name="procurement_organiz_a7e531_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="transaction",
            index=models.Index(
                ...
                name="procurement_organiz_d10069_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="transaction",
            index=models.Index(
                fields=["upload_batch"], name="procurement_upload__7390cf_idx"
            ),
        ),
    ]
