...
from apps.procurement.models import (
    Supplier, Category, Transaction, DataUpload, sanitize_filename
)
from .factories import (
    SupplierFactory, CategoryFactory, TransactionFactory, DataUploadFactory
)
...
class TestTransaction:
    ...
    def test_transaction_duplicates_allowed(self, organization, supplier, category, admin_user):
