...
class TestContractOverview:
    ...
    def test_overview_with_contracts(
    ...
    def test_overview_contract_coverage(
        self, organization, supplier, category, admin_user, contract_factory
    ):
        ...
        non_contracted = SupplierFactory(
            organization=organization, name="Non-Contracted"
        )
        for i in range(5):
            TransactionFactory(
                organization=organization,
...
class TestContractsList:
    ...
    def test_contracts_list_days_to_expiry(
        self, organization, supplier, contract_factory
    ):
...
class TestContractDetail:
    ...
    def test_contract_detail_found(
        self, organization, supplier, category, admin_user, contract_factory
    ):
    ...
    def test_contract_detail_utilization(
        self, organization, supplier, category, admin_user, contract_factory
    ):
...
class TestExpiringContracts:
    ...
    def test_expiring_contracts_found(self, organization, supplier, contract_factory):
        ...
        contract_factory(
            title="Expiring Soon", end_date=date.today() + timedelta(days=30)
        )
    ...
    def test_expiring_contracts_within_notice_period(
        self, organization, supplier, contract_factory
    ):
...
class TestSavingsOpportunities:
    ...
    def test_underutilized_contract(
        self, organization, supplier, category, admin_user, contract_factory
    ):
    ...
    def test_off_contract_spend(
        ...
        non_contracted = SupplierFactory(
            organization=organization, name="Off-Contract Supplier"
        )
        for i in range(10):
            TransactionFactory(
                organization=organization,
...
class TestRenewalRecommendations:
    ...
    def test_renewal_recommendations(
        self, organization, supplier, category, admin_user, contract_factory
    ):
    ...
    def test_renewal_high_utilization(
        self, organization, supplier, category, admin_user, contract_factory
    ):
...
class TestContractVsActualSpend:
    ...
    def test_comparison_specific_contract(
        self, organization, supplier, category, admin_user, contract_factory
    ):
