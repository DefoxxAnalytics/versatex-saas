...
class TestSpendingForecast:
    ...
    def test_spending_forecast_with_data(
    ...
    def test_spending_forecast_trend_detection(
        self, organization, supplier, category, admin_user
    ):
    ...
    def test_spending_forecast_decreasing_trend(
        self, organization, supplier, category, admin_user
    ):
    ...
    def test_spending_forecast_confidence_intervals(
        self, organization, supplier, category, admin_user
    ):
...
class TestTrendAnalysis:
    ...
    def test_trend_analysis_growth_metrics(
        self, organization, supplier, category, admin_user
    ):
        ...
        assert (
            "three_month_growth" in result["growth_metrics"]
            or "six_month_growth" in result["growth_metrics"]
        )
...
class TestBudgetProjection:
    ...
    def test_budget_projection_valid(
        self, organization, supplier, category, admin_user
    ):
...
class TestModelAccuracy:
    ...
    def test_mape_calculation(self, organization, supplier, category, admin_user):
        ...
        if result["model_accuracy"]["data_points_used"] >= 6:
            assert (
                result["model_accuracy"]["mape"] is not None
                or result["model_accuracy"]["mape"] is None
            )
