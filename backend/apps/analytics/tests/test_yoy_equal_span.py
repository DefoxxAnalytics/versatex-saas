...
def _seed_year(
    organization, supplier, category, admin_user, year, months, amount=Decimal("1000")
):
...
class TestYoyEqualSpanGuard:
    ...
    def test_partial_years_omits_growth_percentage(self, organization, admin_user):
        ...
        _seed_year(
            organization, supplier, category, admin_user, year=2024, months=[10, 11, 12]
        )
        _seed_year(
            organization,
            supplier,
        ...
        result = YearOverYearAnalyticsService(
            organization
