            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="analytics_l_organiz_c89ac7_idx",
                    ),
                    models.Index(
                        fields=["organization", "request_type"],
                        name="analytics_l_organiz_eee4ae_idx",
                    ),
                    models.Index(
                        fields=["provider", "model_used"],
                        name="analytics_l_provide_bf766f_idx",
                    ),
                    models.Index(
                        fields=["created_at"], name="analytics_l_created_1d842d_idx"
                    ),
                ],
            },
        ),
