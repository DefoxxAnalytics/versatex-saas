        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text="Document title for display", max_length=255
                    ),
                ),
                (
                    "content",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="analytics_e_organiz_b38e8d_idx",
                    ),
                    models.Index(
                        fields=["organization", "is_active"],
                        name="analytics_e_organiz_aadb14_idx",
                    ),
                    models.Index(
                        fields=["source_model", "source_id"],
                        name="analytics_e_source__995bd6_idx",
                    ),
                    models.Index(
                        fields=["content_hash"], name="analytics_e_content_de2a89_idx"
                    ),
                ],
            },
        ),
