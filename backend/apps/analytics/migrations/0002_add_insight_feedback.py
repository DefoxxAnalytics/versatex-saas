            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="analytics_i_organiz_91f82a_idx",
                    ),
                    models.Index(
                        fields=["organization", "action_taken"],
                        name="analytics_i_organiz_3d0e77_idx",
                    ),
                    models.Index(
                        fields=["organization", "outcome"],
                        name="analytics_i_organiz_8b694e_idx",
                    ),
                    models.Index(
                        fields=["action_date"], name="analytics_i_action__24dcd8_idx"
                    ),
                ],
            },
        ),
