    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "query_text",
                    models.TextField(help_text="Original query/prompt text"),
                ),
                (
                    "query_hash",
                    models.CharField(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["organization", "request_type", "expires_at"],
                        name="analytics_s_organiz_22477f_idx",
                    ),
                    models.Index(
                        fields=["organization", "query_hash"],
                        name="analytics_s_organiz_da0842_idx",
                    ),
                    models.Index(
                        fields=["expires_at"], name="analytics_s_expires_82ed1f_idx"
                    ),
                ],
            },
        ),
