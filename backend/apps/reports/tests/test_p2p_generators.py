...
@pytest.fixture
def purchase_order(
    db, organization, admin_user, supplier, category, purchase_requisition
):
...
class TestPRStatusReportGenerator:
    ...
    def test_summary_kpis(self, organization, admin_user, supplier, category):
        ...
        for i, status in enumerate(
            ["approved", "rejected", "pending", "converted_to_po"]
        ):
...
class TestPOComplianceReportGenerator:
    ...
    def test_maverick_spend_analysis(
        self, organization, admin_user, supplier, category
    ):
    ...
    def test_supplier_compliance(
        self, organization, admin_user, supplier, supplier2, category
    ):
    ...
    def test_insights_for_low_coverage(
        self, organization, admin_user, supplier, category
    ):
    ...
    def test_recommendations_for_maverick(
        self, organization, admin_user, supplier, category
    ):
...
class TestP2PGeneratorIntegration:
    ...
    def test_filters_applied_consistently(
        self, organization, admin_user, supplier, category
    ):
    ...
    def test_organization_isolation(
        self, organization, other_organization, admin_user, supplier, category
    ):
        ...
        other_supplier = Supplier.objects.create(
            organization=other_organization, name="Other Org Supplier"
        )
        other_category = Category.objects.create(
            organization=other_organization, name="Other Org Category"
        )
