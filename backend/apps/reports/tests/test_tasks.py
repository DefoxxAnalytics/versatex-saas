...
class TestProcessScheduledReports:
    ...
    def test_processes_due_reports(
        self, mock_generate, scheduled_report, future_scheduled_report
    ):
    ...
    @patch("apps.reports.tasks.generate_report_async")
    def test_excludes_non_scheduled_reports(
        self, mock_generate, organization, admin_user
    ):
...
class TestTaskEdgeCases:
    ...
    @patch("apps.reports.tasks.generate_report_async")
    def test_error_during_queue(
        self, mock_generate, scheduled_report, organization, admin_user
    ):
