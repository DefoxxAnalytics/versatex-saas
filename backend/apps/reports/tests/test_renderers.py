...
class TestCSVRenderer:
    ...
    def test_render_with_overview_fallback(self):
        ...
        data = {"overview": {"total_spend": 100000, "supplier_count": 50}}
        renderer = CSVRenderer(data, "Test Report")
        result = renderer.render()
    ...
    def test_get_filename(self):
        ...
        data = {"metadata": {"generated_at": "2024-06-15T10:30:00"}}
    ...
    def test_render_multiple_sheets(self):
        ...
        data = {
            "spend_by_category": [{"category": "IT", "amount": 50000}],
            "spend_by_supplier": [{"supplier": "Acme", "amount": 30000}],
        }
        renderer = CSVRenderer(data, "Test Report")
...
class TestExcelRenderer:
    ...
    def test_render_with_data(self):
        ...
        data = {
            "metadata": {"report_type": "spend_analysis", "organization": "Test Org"},
            "overview": {"total_spend": 100000, "supplier_count": 50},
            "spend_by_category": [
    ...
    def test_render_with_branding(self):
        ...
        data = {"overview": {"total_spend": 100000}}
        branding = {"primary_color": "#003366", "secondary_color": "#0066cc"}
...
class TestPDFRenderer:
    ...
    def test_render_with_tables(self):
        ...
        data = {
            "metadata": {"report_title": "Spend Analysis", "organization": "Test Org"},
            "spend_by_category": [
    ...
    def test_render_with_branding(self):
        """Test rendering with organization branding."""
        data = {
            "metadata": {"report_title": "Test Report", "organization": "Branded Corp"},
    ...
    def test_large_dataset_handling(self):
        ...
        # Create 100 items
        data = {
            "metadata": {"report_title": "Large Report", "organization": "Test Org"},
            "spend_by_supplier": [
...
class TestRendererFilenameGeneration:
    ...
    def test_filename_special_characters(self):
        """Filename sanitiser strips anything outside [A-Za-z0-9._-] to `_`.

        Hardened in v3.1 Phase 0 (R-C3): the previous space->`_`/slash->`-`
        rule allowed CR/LF and `"` through, opening Content-Disposition
        header injection and filename-quote escape. The strict allowlist
        blocks all of those.
        """
        ...
        assert filename.startswith("Report_With_Slashes")

    def test_filename_blocks_header_injection(self):
        """CR/LF and quote chars must not survive into Content-Disposition."""
        renderer = CSVRenderer({}, 'Evil\r\nSet-Cookie: x=y "y"')
        filename = renderer.get_filename()
...
class TestRendererDataHandling:
    ...
    def test_pdf_handles_unicode(self):
        ...
        data = {
            ...
            "spend_by_supplier": [{"supplier": "Supplier \u00c0", "amount": 50000}],
        }
            ...
            "insights": [
                {
                    ...
                    "description": "Consolidate suppliers",
                }
            ],
        }
        renderer = PDFRenderer(data, "Executive Summary")
            ...
            "supplier_ranking": [
                {
                    ...
                    "amount": 1000 * (20 - i),
                    "cumulative_percentage": i * 5,
                }
                for i in range(1, 21)
            ],
            "spend_by_classification": {"class_a": 70, "class_b": 20, "class_c": 10},
        }
    ...
    def test_render_yoy_report(self):
        ...
        data = {
            ...
            "monthly_comparison": [
                {
                    "month": f"Month {i}",
                    "year1_spend": 150000 + i * 1000,
                    "year2_spend": 175000 + i * 1500,
                }
                for i in range(1, 13)
            ],
        }
...
class TestPDFRendererKPICards:
    ...
    def test_render_with_kpi_data(self):
        ...
        data = {
            "metadata": {"report_title": "KPI Report", "organization": "Test Org"},
            "overview": {
                "total_spend": 1500000,
                "supplier_count": 75,
...
class TestPDFRendererEdgeCases:
    ...
    def test_null_values_in_data(self):
        ...
        data = {
            ...
            "overview": {"total_spend": 0, "supplier_count": 0},
            "spend_by_category": [{"category": "IT", "amount": 0, "percentage": 0}],
        }
    ...
    def test_special_characters_in_data(self):
        ...
        data = {
            ...
            "spend_by_supplier": [{"supplier": "Vendor <A> & Co.", "amount": 50000}],
        }
    ...
    def test_negative_values(self):
        ...
        data = {
            ...
            "overview": {"total_spend": 100000, "ytd_change": -15.5},
            "spend_by_category": [
    ...
    def test_zero_values(self):
        ...
        data = {
            ...
            "overview": {"total_spend": 0, "supplier_count": 0, "transaction_count": 0},
        }
    ...
    def test_deeply_nested_data(self):
        ...
        data = {
            ...
            "overview": {"totals": {"spend": 100000, "count": 50}},
        }
