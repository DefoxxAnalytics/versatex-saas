...
class TestSeasonalityGeneratorParity:
    ...
    def _build_fixture(self, organization, admin_user):
        ...
        _seed_monthly(
            organization, big_mild, supplier, admin_user,
        ...
        _seed_monthly(
            organization, small_extreme, supplier, admin_user,
        ...
        _seed_monthly(
            organization, mid_moderate, supplier, admin_user,
            [20000, 25000, 30000, 35000, 40000, 45000,
             50000, 55000, 60000, 65000, 70000, 75000],
        )

    def test_savings_opportunities_sorted_by_savings_descending(self, organization, admin_user):
    ...
    def test_category_analysis_reflects_strength_descending_service_order(self, organization, admin_user):
        self._build_fixture(organization, admin_user)
