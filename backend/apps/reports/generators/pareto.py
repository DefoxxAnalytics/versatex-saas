...
class ParetoReportGenerator(BaseReportGenerator):
    ...
    def generate(self) -> dict:
        ...
        efficiency_ratio = (
            (suppliers_for_80 / total_suppliers * 100) if total_suppliers > 0 else 0
        )
        ...
        return {
            ...
            "spend_by_classification": {
                "critical": {
                    ...
                    "percentage": round(
                        (critical_spend / total_spend * 100) if total_spend > 0 else 0,
                        2,
                    ),
                },
                "important": {
                    ...
                    "percentage": round(
                        (important_spend / total_spend * 100) if total_spend > 0 else 0,
                        2,
                    ),
                },
                "standard": {
                    ...
                    "percentage": round(
                        (standard_spend / total_spend * 100) if total_spend > 0 else 0,
                        2,
                    ),
                },
                "tail": {
                    ...
                    "spend": tail_spend,
                    "percentage": round(
                        (tail_spend / total_spend * 100) if total_spend > 0 else 0, 2
                    ),
                },
            },
