...
class TailSpendReportGenerator(BaseReportGenerator):
            ...
            distribution.append(
                {
                    ...
                    "vendor_percentage": round(
                        (
                            (micro.get("count", 0) / total_vendors * 100)
                            if total_vendors > 0
                            else 0
                        ),
                        2,
                    ...
                    "spend_percentage": round(
                        (
                            (micro.get("spend", 0) / total_spend * 100)
                            if total_spend > 0
                            else 0
                        ),
                        2,
            ...
            distribution.append(
                {
                    ...
                    "vendor_percentage": round(
                        (
                            (small.get("count", 0) / total_vendors * 100)
                            if total_vendors > 0
                            else 0
                        ),
                        2,
                    ...
                    "spend_percentage": round(
                        (
                            (small.get("spend", 0) / total_spend * 100)
                            if total_spend > 0
                            else 0
                        ),
                        2,
            ...
            distribution.append(
                {
                    ...
                    "vendor_percentage": round(
                        (
                            (non_tail.get("count", 0) / total_vendors * 100)
                            if total_vendors > 0
                            else 0
                        ),
                        2,
                    ...
                    "spend_percentage": round(
                        (
                            (non_tail.get("spend", 0) / total_spend * 100)
                            if total_spend > 0
                            else 0
                        ),
                        2,
            ...
            highlights.append(
                {
                    ...
                    "impact": (
                        "high"
                        if vendor_ratio > 70
                        else ("medium" if vendor_ratio > 50 else "low")
                    ),
                }
            )
        ...
        highlights.append(
            {
                ...
                "impact": (
                    "high" if tail_pct > 20 else ("medium" if tail_pct > 10 else "low")
                ),
            }
        )
    ...
    def _generate_action_plan(
        self, summary, category_analysis, consolidation_opportunities
    ):
            ...
            actions.append(
                {
                    ...
                    "estimated_savings": round(
                        summary.get("savings_opportunity", 0) * 0.3, 2
                    ),
                    "effort": "Low",
                    "actions": [
    ...
    def _generate_recommendations(
        ...
        high_tail_cats = [
            c for c in category_analysis if c.get("tail_percentage", 0) > 50
        ]
        if high_tail_cats:
