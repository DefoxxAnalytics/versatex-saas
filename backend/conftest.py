...
def user(db, organization):
    ...
    UserProfile.objects.create(
        user=user, organization=organization, role="viewer", is_active=True
    )
    return user
...
def admin_user(db, organization):
    ...
    UserProfile.objects.create(
        user=user, organization=organization, role="admin", is_active=True
    )
    return user
...
def manager_user(db, organization):
    ...
    UserProfile.objects.create(
        user=user, organization=organization, role="manager", is_active=True
    )
    return user
...
def other_org_user(db, other_organization):
    ...
    UserProfile.objects.create(
        user=user, organization=other_organization, role="admin", is_active=True
    )
    return user
...
def inactive_profile_user(db, organization):
    ...
    UserProfile.objects.create(
        user=user, organization=organization, role="viewer", is_active=False
    )
    return user
